	...
	<?php endif; ?>
		...
		<td>
			<?php echo $this->Form->input('start_date', array(
				'dateFormat' => 'Hi:s',
			)); echo $this->Form->input('start_date', array('dateFormat' => 'YmD', 'type' => 'hidden')); ?>
			<?php if ($attendanceTime['VAtTime']['start_date']) { echo  h(date('H:i', strtotime($attendanceTime['VAtTime']['start_date']))); } ?>&nbsp;</td>
